...
from constants import (ARCSECOND)
...
class OrbitalImprovement:
    def __init__(self):
        # Constants paremeter
        self.variation_coordinate = 10e-4
        self.variation_velocity = 10e-6
    ...
    def generate_error(self):
        ...
        return delta_coordinate, delta_velocity
    ...
    def calculate_observation_data(self):
        ...
        for i in range(1, 101):
            # Set-up data
            t_i = dh.add_integration_time(self.t * i)
    ...
    def calculate_calculated_data(self):
        ...
        # Generate the initial prediction for orbit (x10, x20, x30, x'10, x'20, x'30)
        for i in range(1, 101):
            logger.log_info(f"Calculating for iteration: {i}")
            # Set-up data
            t_i = dh.add_integration_time(self.t * i)
            date, month, year, hour, minute, second = dh.julian_date_to_gregorian(t_i)
        ...
        for column in range(6):
            ...
            for i in range(1, 101):
                ...
                for component in range(3):
                    ...
                    variation = self.variation_coordinate if column < 3 else self.variation_velocity
